...
class EmployeeActions(APIView):
    ...
    def post(self, request, company_id):
        ...
        try:
            ...
            return Response({
                ...
                'employee': Employee.serializers.base(instance=employee).data,
        ...
        return Response(data={
            ...
            'employee': Employee.serializers.extended(instance=employee).data,
    ...
    def get(self, request, employee_id, company_id):
        ...
        try:
            return Response({
                ...
                'employee': Employee.serializers.extended(instance=employee.get(id=employee_id)).data
            })
        except:
            return Response(data={
    ...
    def put(self, request, employee_id, company_id):
        validator = Employee.validators.update(data=request.data)
